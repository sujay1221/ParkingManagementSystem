...
<?php
  ...
  $sql = "SELECT a.owner_id,o.owner_fname,o.owner_lname,o.owner_phno,complaint FROM admin_complaint a,owner_table o where a.owner_id=o.owner_id and a.owner_id=".$_SESSION['log_name'].""; 
