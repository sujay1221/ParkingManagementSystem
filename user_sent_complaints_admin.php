...
<div class="row">
    <div class="col">
      <center>
        <img class="img-thumbnail" width="150px" src="img/user.webp">
</center>
    </div>
    <div class="col-4">
    <center>
      <br>
    <h1 class="wt title">User Complaints</h1>
</center>
    </div>
    <div class="col">
    <center>
        <img class="img-thumbnail" width="200px" src="img/complaints.jpeg">
</center>
    </div>
  </div>
  <br>
...
?>
  ...
  <center>
    <br>
    <br> <a class="btn btn-success" href="admin_home.html"> GO BACK</a>
